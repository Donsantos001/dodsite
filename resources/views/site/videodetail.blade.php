...
<section class="header-s">
    <div class="max-w-screen-2xl lg:mx-auto">
        <div class="news-con p-2 w-full rounded-lg shadow-2xl overflow-hidden">
            <div class="flex flex-col">
                ...
                <div class="w-full p-2">
                    <div class="news-det p-2">
                        ...
                        <span class="rounded-full p-1 bg-red-600">BUSINESS MONEY</span> 
                        <p class="py-2">12 May 1996(83382)</p>
                        <p class="my-2">
    ...
    <div class="flex flex-col lg:grid lg:gap-4 2xl:gap-6 lg:grid-cols-3 2xl:row-span-1 2xl:pb-8 pt-4 px-3 h-full max-w-screen-2xl lg:mx-auto">
        ...
        <div class="lg:order-2 lg:row-span-1 2xl:row-span-1 h-full lg:col-span-1 mb-5 lg:mb-0">
            <div class="flex flex-col lg:grid lg:gap-4 2xl:gap-6 lg:grid-cols-1 2xl:row-span-5 pt-4 h-full max-w-screen-2xl lg:mx-auto">
                <div class="lg:order-1 row-span-2 2xl:row-span-2 lg:col-span-1 rounded-lg shadow-2xl overflow-hidden mb-5 lg:mb-0">
                ...
                <div class="bg-gray-900 lg:order-2 row-span-3 2xl:row-span-3 lg:col-span-1 rounded-lg shadow-2xl pb-4 mb-5 lg:mb-0">
                ...
                <div class="lg:order-3 lg:row-span-2 2xl:row-span-2 lg:col-span-1 mb-5 lg:mb-0">
